...
public class get_peccanct_type extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		db.getRs("select * from paccancy_type");
		...
		try {
			if (set != null) {
				...
				while (set.next()) {
					...
					jsonObject3.put("pcode", set.getString(1));
					jsonObject3.put("pmoney", set.getInt(2));
					jsonObject3.put("pscore", set.getInt(3));
					jsonObject3.put("premarks", set.getString(4));
