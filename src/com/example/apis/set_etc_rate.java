...
/**
 * Servlet implementation class set_etc_rate
 */
@WebServlet("/set_etc_rate")
public class set_etc_rate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int row = db.update("update mode_table set etc_rate='" + money + "'");
		if (row == 1) {
