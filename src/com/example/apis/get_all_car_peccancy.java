...
/**
 * Servlet implementation class get_all_car_peccancy
 */
@WebServlet("/get_all_car_peccancy")
public class get_all_car_peccancy extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		db.getRs("select * from car_paccancy");
