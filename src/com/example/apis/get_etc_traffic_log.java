...
/**
 * Servlet implementation class get_etc_traffic_log
 */
@WebServlet("/get_etc_traffic_log")
public class get_etc_traffic_log extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public get_etc_traffic_log() {
        super();
		...
		try {
			if (set != null) {
				...
				while (set.next()) {
					...
					jsonObject3.put("carid", set.getInt(2));
					jsonObject3.put("intime", set.getString(3));
					jsonObject3.put("outtime", set.getString(4));
					jsonObject3.put("money", set.getInt(5));
