...
/**
 * Servlet implementation class get_light_value
 */
@WebServlet("/get_light_value")
public class get_light_value extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public get_light_value() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			if (set != null&&set.next()) {
				...
				jsonObject2.put("upper", set.getInt(2));
				jsonObject2.put("lower", set.getInt(3));
			} else {
