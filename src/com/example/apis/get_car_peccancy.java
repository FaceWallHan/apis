...
/**
 * Servlet implementation class get_car_peccaney
 */
@WebServlet("/get_car_peccancy")
public class get_car_peccancy extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		db.getRs("select * from car_paccancy where carnumber = '" + carnumber + "'");
		...
		try {
			if (set != null) {
				...
				while (set.next()) {
					...
					jsonObject3.put("carnumber", set.getString(2));
					jsonObject3.put("pcode", set.getString(3));
					jsonObject3.put("paddr", set.getString(4));
					jsonObject3.put("datetime", set.getString(5).replace(".0",""));
