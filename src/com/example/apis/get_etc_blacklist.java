...
/**
 * Servlet implementation class get_etc_blacklist
 */
@WebServlet("/get_etc_blacklist")
public class get_etc_blacklist extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public get_etc_blacklist() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		db.getRs("select * from car_black");
		...
		try {
			if (set != null) {
				...
				while (set.next()) {
					...
					jsonObject3.put("datetime", set.getString(3));
