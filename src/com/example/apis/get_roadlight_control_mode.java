...
/**
 * Servlet implementation class get_roadlight_control_mode
 */
@WebServlet("/get_roadlight_control_mode")
public class get_roadlight_control_mode extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public get_roadlight_control_mode() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		db.getRs("select * from mode_table");
		ResultSet set = db.getRs();
		try {
			if (set != null&&set.next()) {
				jsonObject2.put("RESULT", "S");
				jsonObject2.put("ERRMSG", "成功");
				jsonObject2.put("ControlMode", set.getString(1));
			} else {
