...
/**
 * Servlet implementation class get_car_account_fee
 */
@WebServlet("/get_car_account_fee")
public class get_car_account_fee extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public get_car_account_fee() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		db.getRs("select * from account_fee where carId = '" + carId + "'");
